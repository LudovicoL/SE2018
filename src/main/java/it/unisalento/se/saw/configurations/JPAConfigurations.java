...
public class JPAConfigurations {
	...
	//mette i dati di sopra in environment. qui sotto richiama i campi di environment con i dati per l'accesso del db
	@Bean
	...
	//gli oggetti di dominio trovi qui giù
	entityManagerFactoryBean.setPackagesToScan(environment.getRequiredProperty(PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN));
	entityManagerFactoryBean.setJpaProperties(hibProperties());
	return entityManagerFactoryBean;
	}
//giù proprietà relative alle transazioni
